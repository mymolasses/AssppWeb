...
export default function ProductDetail() {
  ...
  useEffect(() => {
    if (productAccounts.length > 0) {
      const selectedStillExists = productAccounts.some(
      ...
      if (!previewEnabled) setSelectedAccountEmail(nextAccount);
    }
  }, [
    productAccounts,
    previewEnabled,
            ...
            <div className="min-w-0">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (!previewEnabled) setSelectedAccountEmail(e.target.value);
                }}
